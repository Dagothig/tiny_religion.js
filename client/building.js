...
class Building extends PIXI.TiledSprite {
    ...
    isInRadius(o, radius) {
        ...
        return radius ?
            Math.dst(this.x, this.y, o.x, o.y) < this.radius + o.radius :
...
let Bridge = new BuildingType(
    'bridge', '/images/Bridge.png', -10, -47, -30, false, 360, 10000, {
        building() { this.island.bridge = this; }
    }),
House = new BuildingType(
    'house', '/images/House.png', 0, 0, 16, true, 40, 2000),
Barracks = new BuildingType(
    'barracks', '/images/Barracks.png', 0, 0, 16, true, 90, 10000),
Workshop = new BuildingType(
    'workshop', '/images/Workshop.png', 0, 0, 16, true, 90, 10000),
Temple = new BuildingType(
    'temple', '/images/Temple.png', 0, 0, 16, true, 90, 10000),
GreenHouse = new BuildingType(
    'greenHouse', '/images/GreenHouse.png', 0, 0, 16, true, 90, 10000),
Tree = new BuildingType(
    'tree', '/images/Tree.png', 0, 4, 0, false, 35, 1000, {
        update(delta, game) { this.progressBuild(1); }
    }),
FallingTree = new BuildingType(
    'fallingTree', '/images/FallingTree.png', 0, 4, 0, false, 35, 250, {
