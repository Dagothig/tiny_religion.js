...
import Minotaur from './person/minotaur';
import Building from './building';
import Bridge from './building/bridge';
import Statue from './building/statue';
import Tree from './building/tree';
import BigTree from './building/big-tree';
import SFX from './sfx';
import { Blood, Summon, Sparkle, Lightning, TopBeam, BigSummon, Explosion } from './sfx/sfx-type';
