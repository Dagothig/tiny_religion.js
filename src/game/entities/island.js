...
import Villager from './person/villager';
import Warrior from './person/warrior';
import Builder from './person/builder';
import Priest from './person/priest';
...
class Island extends PIXI.Container {
    ...
    changeKingdom(newKingdom) {
        ...
        this.kingdom.events.trigger();

        newKingdom.events.trigger('island', { oldKingdom, newKingdom });
        oldKingdom.events.trigger('island', { oldKingdom, newKingdom });
    }
